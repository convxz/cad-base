...
urlpatterns = [
    ...
    path("catalog/<int:pk>/", views.model_detail, name="model_detail"),
    ...
    path(
        "adocumentation/edit/<int:pk>/", views.document_edit_view, name="edit_document"
    ),
    path(
        "adocumentation/delete/<int:pk>/",
    ...
    path(
        "security/change-password/", views.password_change_view, name="password_change"
    ),
    path("profile/", views.profile_view, name="profile"),
    path(
        "download/<int:pk>/<str:file_format>/",
        views.download_file,
        name="download_file",
    ),
